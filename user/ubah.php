...
<!-- FORM -->
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea name="product_desc" class="form-control" id="product_desc" placeholder="Deskripsi" value="<?= $product["product_desc"]?>"></textarea>
        </div>
        <button type="submit" name="ubah" class="btn btn-success">Register</button>
    </form>
